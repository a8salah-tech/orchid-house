...
const ROLES: Record<string, { label: string; color: string; bg: string; icon: string }> = {
  ...
  general_supervisor:   { label: 'مشرف عام',       color: '#0EA5E9', bg: 'rgba(14,165,233,0.12)',  icon: '🧭' },
  ...
  cashier_manager:      { label: 'مدير كاشير',     color: '#059669', bg: 'rgba(5,150,105,0.12)',   icon: '🧾' },
  ...
  maintenance_worker:   { label: 'عامل صيانة',     color: '#F59E0B', bg: 'rgba(245,158,11,0.12)',   icon: '🔧' },
  delivery_worker:      { label: 'عامل توصيل',     color: '#EC4899', bg: 'rgba(236,72,153,0.12)',   icon: '🛵' },
  ...
  kitchen_display:      { label: 'شاشة المطبخ',   color: '#F97316', bg: 'rgba(249,115,22,0.12)',   icon: '📺' },
...
export default function EmployeesPage() {
  ...
  // ── صلاحيات مفصّلة ──
  // ── منع الوصول لغير المصرح لهم — صفحة الموظفين متاحة فقط لمدير النظام ──
