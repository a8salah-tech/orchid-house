                                  ...
                                  <td key={d.day} style={{padding:'2px',textAlign:'center',background:isToday?'rgba(201,168,76,0.04)':'transparent'}}>
                                    {sch?(
                                      <div
                                        ...
                                        style={{background:(sch.shifts?.color||S.purple)+'30',border:`1px solid ${(sch.shifts?.color||S.purple)}60`,borderRadius:4,padding:'2px 1px',fontSize:9,fontWeight:800,color:sch.custom_start?S.purple:(sch.shifts?.color||S.gold),lineHeight:1.2}}>
                                        {sch.custom_start ? sch.custom_start.slice(0,5) : (sch.shifts?.name?.slice(0,3)||'✓')}
                                      </div>
                                    ):(
