...
const ROLE_LABELS: Record<string, { ar: string; en: string; icon: string; color: string }> = {
  ...
  general_supervisor:  { ar: 'مشرف عام',      en: 'General Supervisor', icon: '🧭', color: '#0EA5E9' },
  cashier:             { ar: 'كاشير',         en: 'Cashier',            icon: '💰', color: S.green },
  assistant_cashier:   { ar: 'مساعد كاشير',   en: 'Asst. Cashier',      icon: '💳', color: '#34D399' },
  cashier_manager:     { ar: 'مدير كاشير',    en: 'Cashier Manager',    icon: '🧾', color: '#059669' },
  ...
  kitchen_cleaner:     { ar: 'عامل نظافة مطبخ', en: 'Kitchen Cleaner',  icon: '🧹', color: '#86EFAC' },
  hall_cleaner:        { ar: 'عامل نظافة صالة', en: 'Hall Cleaner',     icon: '🧽', color: '#6EE7B7' },
  maintenance_worker:  { ar: 'عامل صيانة',     en: 'Maintenance Worker', icon: '🔧', color: '#F59E0B' },
...
{ group: 'إدارة المخزون', items: [
    ...
    { label: 'حركة صنف',     label_en: 'Item Movement',   icon: '📜', path: '/dashboard/item-movement',   permission: 'admin_only' },
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 6 : 10, minWidth: 0 }}>
            ...
            {!isMobile && (
              <div>
                ...
                <div style={{ fontSize: 9, color: S.muted, letterSpacing: 1.5, fontWeight: 600, marginTop: 2, fontFamily: 'monospace' }}>V.045.289</div>
              </div>
            )}
          </div>
        </div>
